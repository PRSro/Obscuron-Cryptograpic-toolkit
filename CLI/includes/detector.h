...
std::vector<CipherCandidate> detect_cipher(const std::string &input, int top_n, bool aggressive = false);
std::vector<CipherCandidate> detect_cipher_no_branch(const std::string &input, int top_n, bool aggressive = false);
