...
void PassiveWindow::setupUI() {
    ...
    QString baseStyle =
        ...
        "QTextEdit, QPlainTextEdit { background:#120a20; color:#e0e0f0;"
        "  border:1px solid #1e1850; border-radius:4px; padding:8px;"
        "  font-family:'Courier New',monospace; font-size:12px; }"
        "QTextEdit:focus, QPlainTextEdit:focus { border:1px solid #4a7cff; }"
        "QLineEdit { background:#120a20; color:#e0e0f0;"
        "  border:1px solid #1e1850; border-radius:4px; padding:4px 8px;"
        "  min-height:24px; }"
        "QLineEdit:focus { border:1px solid #4a7cff; }"
        "QComboBox { background:#120a20; color:#e0e0f0;"
        "  border:1px solid #1e1850; border-radius:4px; padding:4px 8px;"
        "  min-height:24px; min-width:120px; }"
        ...
        "QPushButton { background:#1a1030; color:#e0e0f0;"
        "  border:1px solid #1e1850; border-radius:4px; padding:8px 20px;"
        "  font-family:'Courier New',monospace; font-size:12px; }"
        "QPushButton:hover { border:1px solid #4a7cff; color:#6b9cff; }"
        "QPushButton:pressed { background:#006644; }"
        "QPushButton:disabled { color:#3a3860; border-color:#1a1040; }"
        "QLabel { color:#e0e0f0; font-family:'Courier New',monospace; }"
        "QGroupBox { border:1px solid #1e1850; border-radius:6px;"
        "  margin-top:12px; padding-top:16px; font-family:'Courier New',monospace;"
        "  color:#7a7898; }"
        "QGroupBox::title { subcontrol-origin:margin; left:12px; padding:0 4px; }"
        "QTabWidget::pane { border:1px solid #1e1850; background:#0a0514; }"
        "QTabBar::tab { background:#1a1030; color:#7a7898;"
        "  border:1px solid #1e1850; padding:8px 20px;"
        "  font-family:'Courier New',monospace; font-size:11px; }"
        "QTabBar::tab:selected { background:#120a20; color:#6b9cff;"
        "  border-bottom:2px solid #4a7cff; }"
        "QTabBar::tab:hover { color:#e0e0f0; }"
        "QScrollBar:vertical { background:#0a0514; width:10px; }"
        "QScrollBar::handle:vertical { background:#1e1850; border-radius:5px; }"
    ...
    QPalette tp;
    tp.setColor(QPalette::WindowText, QColor(107, 156, 255));
    title->setPalette(tp);
    statusLabel = new QLabel("Disconnected");
    statusLabel->setStyleSheet("color:#7a7898; font-size:11px;");
    ...
    settingsPanel->setStyleSheet("background:#0d0718; border-bottom:1px solid #1e1850;");
