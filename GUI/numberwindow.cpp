...
QWidget* NumberWindow::createAttackTab() {
    ...
    desc->setStyleSheet("color: #7a7898; font-size:11px;");
    ...
    attackRunBtn->setStyleSheet(
        "QPushButton { background:#501010; color:#ff6b6b; border:1px solid #802020;"
        "  border-radius:4px; font-size:13px; font-weight:bold; }"
        "QPushButton:hover { border-color:#ff4a4a; color:#ff4a4a; background:#301010; }"
    );
...
void NumberWindow::setupUI() {
    ...
    QString baseStyle =
        ...
        "  border-radius:4px; padding:2px 4px; min-height:24px; }"
        ...
        "QTabBar::tab { background:#1a1030; color:#7a7898; border:1px solid #1e1850;"
        "  padding:8px 20px; font-family:'Courier New',monospace; font-size:11px; }"
        "QTabBar::tab:selected { background:#120a20; color:#6b9cff; border-bottom:2px solid #4a7cff; }"
